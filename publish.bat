...
"%nuget%" push nuget\Atom.Base64Url.1.0.0.nupkg -Source https://api.nuget.org/v3/index.json -SkipDuplicate
"%nuget%" push nuget\Atom.CheckType.1.0.0.nupkg -Source https://api.nuget.org/v3/index.json -SkipDuplicate

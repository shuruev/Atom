...
"%nuget%" push nuget\Atom.HashBuilder.1.0.2.nupkg -Source https://api.nuget.org/v3/index.json -SkipDuplicate
"%nuget%" push nuget\Atom.Parse.1.2.1.nupkg -Source https://api.nuget.org/v3/index.json -SkipDuplicate
"%nuget%" push nuget\Atom.RunProcess.1.0.0.nupkg -Source https://api.nuget.org/v3/index.json -SkipDuplicate
"%nuget%" push nuget\Atom.TypeName.1.0.0.nupkg -Source https://api.nuget.org/v3/index.json -SkipDuplicate
"%nuget%" push nuget\Atom.XConsole.1.2.0.nupkg -Source https://api.nuget.org/v3/index.json -SkipDuplicate
